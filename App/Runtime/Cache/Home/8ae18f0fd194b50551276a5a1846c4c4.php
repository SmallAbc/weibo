        ...
        <li class="app"><span>消息
            <dl class="list">
                <dd><a href="<?php echo U('Setting/refer');?>">
                        <!--<?php if(empty($count)): ?>@提及我的
                            <?php else: ?>
                            @提及我<span class="refercount">(<?php echo ($count); ?>)</span><?php endif; ?>-->
            ...
            <?php if(is_array($topiclist)): $i = 0; $__LIST__ = $topiclist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$obj): $mod = ($i % 2 );++$i;?><dl class="weibo_content_data">
                    ...
                    <dd>
                        ...
                        <div class="forward_box fc_box" style="display: none">
                            <span>请输入转发评论:</span>
                            <textarea class="forward_text"  name="forward_text">//@<?php echo ($obj["username"]); ?> : <?php echo ($obj["textarea"]); ?></textarea>
                            <?php if(empty($obj["forward_content"]["id"])): ?><input type="hidden" value="<?php echo ($obj["id"]); ?>" name="resource_id" class="resource_id">
                                <?php else: ?>
                                <input type="hidden" value="<?php echo ($obj["forward_content"]["id"]); ?>" name="resource_id" class="resource_id"><?php endif; ?>
                        ...
                        <div class="comment_box fc_box" style="display: none">
                            ...
                            <div>
                                <p class="loading_comment" ><img  src="/weibo/Public/Home/img/loadmore.gif" alt="">评论加载中</p>
                            </div>
                        </div>
                        <div class="footer">
